...
def main():
    ...
    parser.add_argument("--layernorm_key", default=True, action="store_true", help="Adds layernorm to the model.")
    parser.add_argument("--layernorm_value", action="store_true", help="Adds layernorm to the model.")
    parser.add_argument("--div_sqrt", default=True, action="store_true", help="Divides by the sqrt(dimension).")
    ...
    parser.add_argument("--do_truncate", default=True, action="store_true", help="If specified reads the graph from the\
        truncated graph paths.")
    parser.add_argument("--diff_pad_zero",default=True, action="store_true")
    ...
    parser.add_argument("--with_graph", default=True, action="store_true", help="If specified use the graph input.") #--------------------------------------------------------------------
    # Bert parameters.
    ...
    parser.add_argument('--overwrite_output_dir',  default=True, action='store_true',#-----------------------here-----------------------------------------------------------------------
    ...
    parser.add_argument('--input_labeled_graph',  default=False, action='store_true',
    ...
    args.task_to_data_dir = {
        ...
        "sst-2": "/idiap/user/rkarimi/dev/SentEval/data/GLUE/SST-2",
        "mnli": "./preprocess/scripts/MNLI",#----------------------------------------
        "mnli-mm": "./preprocess/datasets/SentEval/data/GLUE/MNLI",
        "mrpc": "/idiap/user/rkarimi/dev/SentEval/data/downstream/MRPC",
        "sts-b": "/idiap/user/rkarimi/dev/SentEval/data/GLUE/STS-B",
        ...
        "sick": "/idiap/temp/rkarimi/datasets/SICK/",
        "glue": "/idiap/temp/rkarimi/datasets/GLUEDiagnostic/",
        ...
        "HANS": "/idiap/user/rkarimi/dev/rubi/discourse/hans",
    ...
    args.task_to_graph_dir = {
        "mnlitest": "/idiap/temp/rkarimi/datasets/nli_parsing/mnlitest", 
        "mnlimicro": "/idiap/temp/rkarimi/datasets/nli_parsing/mnlimicro",
        "snlihard": "/idiap/temp/rkarimi/datasets/nli_parsing/snlihard",
        "snli": "./preprocess/nli_parsing/semantic/slni_truncate_128",
        "snli-hard": "./preprocess/nli_parsing/semantic/slni-hard_truncate_128",
        "mnlismall": "/idiap/temp/rkarimi/datasets/nli_parsing/mnli",
        "mnli": "./preprocess/nli_parsing/semantic/mnli",#----------------------------------------
        "mnli-mm": "/idiap/temp/rkarimi/datasets/nli_parsing/mnli",
        "HANS-const": "/idiap/temp/rkarimi/datasets/nli_parsing/hans/constituent",
        "HANS-lex": "/idiap/temp/rkarimi/datasets/nli_parsing/hans/lexical_overlap",
        "HANS-sub": "/idiap/temp/rkarimi/datasets/nli_parsing/hans/subsequence",
        "MNLIMatchedHardWithHardTest":"/idiap/temp/rkarimi/datasets/nli_parsing/mnlimatchedharddev", 
        "MNLIMismatchedHardWithHardTest": "/idiap/temp/rkarimi/datasets/nli_parsing/mnlimismatchedharddev", 
        "QQP": "/idiap/temp/rkarimi/datasets/nli_parsing/qqp",
        "joci" : "/idiap/temp/rkarimi/datasets/nli_parsing/joci",
        "dpr": "/idiap/temp/rkarimi/datasets/nli_parsing/dpr",
        "mpe": "/idiap/temp/rkarimi/datasets/nli_parsing/mpe",
        "sick": "/idiap/temp/rkarimi/datasets/nli_parsing/sick",
        "glue": "/idiap/temp/rkarimi/datasets/nli_parsing/glue",
        "scitail": "/idiap/temp/rkarimi/datasets/nli_parsing/scitail",
        "fnplus": "/idiap/temp/rkarimi/datasets/nli_parsing/fnplus", 
        "addonerte": "/idiap/temp/rkarimi/datasets/nli_parsing/addonerte",
        "sprl": "/idiap/temp/rkarimi/datasets/nli_parsing/sprl",
    }
